    ...
    public partial class IdentityCoreInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Curso_Instructor", x => new { x.CursoId, x.InstructorId });
                    table.ForeignKey(
                        name: "FK_Curso_Instructor_Curso_CursoId",
                        column: x => x.CursoId,
                        principalTable: "Curso",
                        principalColumn: "CursoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Curso_Instructor_Instructor_InstructorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Curso_Instructor_InstructorId",
